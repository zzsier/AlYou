...
import com.imalu.alyou.domain.BitmapCache;
import com.imalu.alyou.domain.BitmapCache.ImageCallback;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((Bimp.drr.size() + selectTotal) < 5) {
				...
				} else if ((Bimp.drr.size() + selectTotal) >= 5) {
