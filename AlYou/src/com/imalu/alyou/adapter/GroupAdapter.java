...
public class GroupAdapter extends ArrayAdapter<ConversationGroup> {

	private LayoutInflater inflater;

	public GroupAdapter(Context context, int res, List<ConversationGroup> groups) {
...
//		} else {
		Log.e("GroupAdapter", "position is "+position);
			if (convertView == null) {
